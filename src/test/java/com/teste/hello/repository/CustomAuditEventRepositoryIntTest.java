package com.teste.hello.repository;

import com.teste.hello.TestehelloApp;
import com.teste.hello.config.Constants;
import com.teste.hello.config.audit.AuditEventConverter;
import com.teste.hello.domain.PersistentAuditEvent;
...
import static com.teste.hello.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
